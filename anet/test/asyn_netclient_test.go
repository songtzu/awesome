...
func (a *asynClientImpl) IOnProcessPack(pack *anet.PackHead) {
...
func asynRun() {
	...
	isTimeout, pack := imp.conn.WriteMessageWaitResponseWithinTimeLimit(pack, 1000)

	fmt.Println("是否超时:",isTimeout,"回包内容", pack)
